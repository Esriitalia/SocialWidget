define([
    ...
    infoTemplateHtml
        ...
        return declare(null, {
            ...
            name: "Instagram",
            layerName: "instagram",
            pointerImageName: "instagramPointer.png",
...
//                    '/webappviewer/widgets/MyWidgets/SocialWidget/images/' + this.pointerImageName,
            ...
            search: function (/*Extent*/ extent, /*String*/ recursiveQuery) {
                ...
                if (!recursiveQuery) {
                    ...
                    var radius = this._getRadiusFromExtent(extent) * 1000;

                    searchParameters = {
                        access_token: cookie("instagram-token"),
                ...
                requestScript.get(url, {
                    ...
                    try {   
                        ...
                        recursiveQuery = data.pagination.next_url;
