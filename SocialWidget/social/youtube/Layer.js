define([
    ...
    infoTemplateHtml
        ...
        return declare(null, {
            ...
            name: "YouTube",
            layerName: "youtube",
            pointerImageName: "youtubePointer.png",      
...
//                    '/webappviewer/widgets/MyWidgets/SocialWidget/images/' + this.pointerImageName,
            ...
            search: function (/*Extent*/ extent, /*String*/ recursiveQuery) {
                ...
                if(query){ this.layer.name += " - " + query;}   
                ...
                var beforeDate = this.widget.txtDate.value;
                
                beforeDate = new Date(beforeDate);
                
                if(this._isToday(beforeDate)){
                   
                    beforeDate = stamp.toISOString(new Date());                    
                    
                }else{
                    
                    beforeDate = stamp.toISOString(beforeDate);
                }
                ...
                searchParameters = {
                    ...
                    type: "video",
                    maxResults: this.maxItemPerRequest,
                ...
                if (recursiveQuery) {
                    ...
                    searchParameters.pageToken = recursiveQuery;                                                           
                }
            ...
            _parse: function (/*Object*/ data, /*Extent*/ extent) {
                ...
                //          Since the data are incomplete, another request is done to the server 
                //          in order to get the missing informations, like the coordinates of the videos.
                ...
                var elementArray = Element.parseList(data);
                
                var elementCommaSeparated = elementArray.toString();
                            
                var token = cookie("youtube-token");                                  
            
                if (this._isExtentFull()) { return; }                           

                var url = this.urls.video;
                
                var nextPageToken = data.nextPageToken;  
                
                var _search = lang.hitch(this, this.search);                        
                
                searchParameters = {
                    part: "id,snippet,recordingDetails", 
                    id: elementCommaSeparated,        
                    "access_token": token     
                };        
                ...
                requestScript.get(url, {
                    ...
                    try {                                        
                        ...
                        var videos = Element.parseVideo(data);  
                                                 
                        array.forEach(videos, function (v) {
                                                        
                            this._addGraphicToLayer(v);  
                        ...
                        if (nextPageToken) {                      
                            ...
                            this.searchTimeout = setTimeout(_search(extent, nextPageToken), 1000);                        
                        }
            ...
            _isToday: function(/*Date*/date){
                
                //summary: 
                //          Checks if the input date is equal to today
                //             
                //return:
                //          True if it is, false otherwise
                // 
                
                var today = locale.format(new Date(), {
                    selector: "date", 
                    formatLength: "short"
                });
